...
def get_array(test_data, f1, f2, f3, f4):
    ...
    return target_energies, predict_energies, predicted_pi, observed_pi
...
def nndnn(test_data):
    ...
    f3 = lambda batch_data: delta_model.get_energies(batch_data).item() / np.sqrt(batch_data['n_atoms'].item())
