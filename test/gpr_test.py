...
#para = torch.load('parameter.pkl')
#etas = para['representation.RDF.etas']
#rss = para['representation.RDF.rss']
...
tmp_list = _collate_aseatoms([get_dict(atoms, environment_provider) for atoms in a[100:]])
epoch = 100
